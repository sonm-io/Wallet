module.exports = {
    ...
    waitForAccountPageLoading: function() {
        return shared.wdHelper.findVisibleElement(
            this.elements.importAccountButton,
        );
    },
    ...
    checkSendTabIsDisabled: function() {
        return page.common.checkElementIsDisabled(
    ...
    logoutFromWallet: async function() {
        return await shared.wdHelper
            .findVisibleElement(this.elements.logoutButton)
            .click();
    },
    ...
    addToken: function() {
        return shared.wdHelper
            .findVisibleElement(this.elements.addTokenButton)
            .click();
    },
