module.exports = {
    ...
    fillNewWalletDialogue: async function(
        ...
        await shared.wdHelper
            .findVisibleElement(this.elements.nwName)
            .sendKeys(walletName);
        await shared.wdHelper
            .findVisibleElement(this.elements.nwPass)
            .sendKeys(pass);
        await shared.wdHelper
            .findVisibleElement(this.elements.nwPassConfirm)
            .sendKeys(confirm);
    ...
    createNewWalletButton: async function() {
        await shared.wdHelper
            .findVisibleElement(this.elements.createNewWallet)
            .click();
    },
