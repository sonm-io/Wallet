module.exports = {
    ...
    closeCreateNewWalletDialogue: function() {
        return shared.wdHelper
            .findVisibleElement(this.elements.closeDialogue)
            .click();
    },
    ...
    searchFromWalletDropdown: async function(searchValue) {
        await page.common.enterValueForSearch(
    ...
    getValuesFromWalletDropdown: function() {
        return page.common.getValuesFromDropdown(
    ...
    createWalletFromStartPage: async function() {
        await shared.wdHelper
            .findVisibleElement(this.elements.createWallet, 15)
            .click();
    },
    ...
    clickImportWalletButton: function() {
        return shared.wdHelper
            .findVisibleElement(this.elements.importWallet)
            .click();
    },
};
