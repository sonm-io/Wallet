module.exports = {
    ...
    waitForAccountsPage: async function () {
        console.log(await shared.wdHelper.findVisibleElement(this.elements.accountsForm));
        return await shared.wdHelper.findVisibleElement(this.elements.accountsForm);
    },

    closeCreateNewWalletDialogue: async function () {
        return (await shared.wdHelper.findVisibleElement(this.elements.closeDialogue)).click();
    },
    ...
    createWalletFromStartPage: async function () {
        console.log(await shared.wdHelper.findVisibleElement(this.elements.createWallet));
