...
export interface IDeletableItemWithConfirmationProps<TItemProps>
    extends IDeletableItemProps {
    Confirmation: React.ComponentClass<TItemProps> | React.SFC<TItemProps>;
    item: TItemProps;
}

export class DeletableItemWithConfirmation<T> extends React.PureComponent<
    IDeletableItemWithConfirmationProps<T>,
    any
> {
    public state = {
    ...
    public static defaultProps: Partial<
        IDeletableItemWithConfirmationProps<any>
    > = {
    ...
    public render() {
        const { onDelete, Confirmation, children, item, ...rest } = this.props;
