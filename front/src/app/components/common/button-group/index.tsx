...
export class ButtonGroup<TValue> extends React.Component<
    IButtonGroupProps<TValue>,
    any
> {
    ...
    protected handleChange = (event: any) => {
        ...
        if (this.props.onChange) {
            ...
            const value = this.props.valueList.find(
                x => this.getKeyValue(x) === key,
            );
    ...
    public render() {
        const { valueList, value, className } = this.props;
        ...
        return (
            <div className={cn('sonm-button-group', className)}>
                {valueList.map(x => {
                    ...
                    return (
                        <label key={key} className="sonm-button-group__item">
                            <input
