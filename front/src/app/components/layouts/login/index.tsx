...
export const Login = withRootStore(
                    ...
                    >
                        ...
                        <FormRow>
                            <FormField
                                ...
                                label="Wallet file"
                                error={
                                    this.state.serverValidation.encodedWallet
                                }
                                success={
        ...
        public render() {
            ...
            return (
                ...
                >
                    ...
                    <div className="sonm-login__version">
                        Version: {VERSION}
                    </div>
                </LoadMask>
            );
