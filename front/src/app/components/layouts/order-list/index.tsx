...
export const OrderList = withRootStore(
    observer(
                    ...
                    <OrderListView
                        ...
                        filterPanel={
                            <OrderFilterPanel
                                ...
                                creatorAddress={
                                    filterStore.userInput.creatorAddress
                                }
                                orderOwnerType={
                                    filterStore.userInput.orderOwnerType
                                }
                                ...
                                professional={
                                    filterStore.userInput.professional
                                }
                                ...
                                cpuCountFrom={
                                    filterStore.userInput.cpuCountFrom
                                }
                                cpuCountTo={filterStore.userInput.cpuCountTo}
                                gpuCountFrom={
                                    filterStore.userInput.gpuCountFrom
                                }
                                ...
                                storageSizeFrom={
                                    filterStore.userInput.storageSizeFrom
                                }
                                storageSizeTo={
                                    filterStore.userInput.storageSizeTo
                                }
                                redshiftFrom={
                                    filterStore.userInput.redshiftFrom
                                }
                                ...
                                gpuRamSizeFrom={
                                    filterStore.userInput.gpuRamSizeFrom
                                }
                                gpuRamSizeTo={
                                    filterStore.userInput.gpuRamSizeTo
                                }
