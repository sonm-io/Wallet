...
export const Deal = withRootStore(
    observer(
        class extends Layout<IProps> {
                ...
                this.dealDetailsStore.updateUserInput({
                    newPrice:
                        changeRequest && changeRequest.price
                            ...
                            : '',
                    newDuration:
                        (changeRequest && changeRequest.duration) || '',
            ...
            public handleConfirmationDialogSubmit = async () => {
                ...
                if (
                    dealDetailsStore.action === DealActions.cancelChangeRequest
                ) {
            ...
            public render() {
                ...
                return (
                    <DealView
                        ...
                        changeRequestList={
                            isOwner ? (
                                <ChangeRequestList
                                    ...
                                    mySide={mySide}
                                    onCreateRequest={
                                        this.handleChangeRequestCreate
                                    }
                                    onCancelRequest={
                                        this.handleChangeRequestCancel
                                    }
                                    onChangeRequest={
                                        this.handleChangeRequestEdit
                                    }
                                    onRejectRequest={
                                        this.handleChangeRequestReject
                                    }
                                    onAcceptRequest={
                                        this.handleChangeRequestAccept
                                    }
                                />
                            ) : (
                                undefined
                        ...
                        confirmationDialogIsBlacklisted={
                            dealDetailsStore.isBlacklisted
                        }
                        ...
                        confirmationDialogOnCheckboxChange={
                            this.handleChangeCheckbox
                        }
                        confirmationDialogOnSubmit={
                            this.handleConfirmationDialogSubmit
                        }
                        confirmationDialogOnCancel={
                            this.handleConfirmationDialogHide
                        }
                        confirmationDialogOnClose={
                            this.handleConfirmationDialogHide
                        }
                        ...
                        confirmationDialogIsFormValid={
                            dealDetailsStore.isFormValid
                        }
                    />
                );
            }
