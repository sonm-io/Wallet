...
import { IHasRootStore, withRootStore } from 'app/components/layouts/layout';
...
class CreateAccountLayout extends React.Component<IProps, any> {
    // ToDo make stateless
...
export const CreateAccount = withRootStore(CreateAccountLayout);
