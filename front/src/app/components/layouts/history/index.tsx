...
export const History = withRootStore(
    observer(
            ...
            protected columns: Array<ColumnProps<ISendTransactionResult>> = [
                ...
                },
                {
                    ...
                    render: (_, record) => {
                        ...
                        return [
                            <div
                                key="0"
                                className="sonm-tx-list__cell-from-name"
                            >
                                {name}
                            </div>,
                            <IdentIcon
                ...
                },
                {
                    ...
                    render: (_, record) => {
                        ...
                        return (
                            <div className="sonm-tx-list__cell-amount-ct">
                                {result}
                            </div>
                        );
                    },
                ...
                },
                {
                    ...
                    render: (_, record) => {
                        const cls = `sonm-tx-list__cell-status--${
                            record.status
                        }`;

                        return (
                            <div
                                className={cn('sonm-tx-list__cell-status', cls)}
                            >
                                {record.status}
                            </div>
                        );
