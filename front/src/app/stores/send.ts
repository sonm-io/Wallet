...
export class SendStore implements ISendStore {
  ...
  @observable
  public currencyMap: ICurrencyMap = {};

  @observable
  public accountMap: IAccountMap;
  ...
  public *loadCurrencies() {
    try {
      this.accountMap = (yield api.methods.getCurrencyList()).reduce((acc: ICurrencyMap, currency: api.ICurrencyInfo) => {
